# Amit Prasad
**Mobile Engineer (React Native) · Indie iOS & Android Developer**

## Summary

- React Native engineer, 3+ years building and shipping production mobile apps
- Independent since Aug 2025 — client work plus 4 self-published indie apps
- Own the full lifecycle on every app: architecture, UI, App Store/Play Store setup, and post-launch support
